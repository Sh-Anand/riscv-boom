...
object XDecode extends DecodeConstants
{
  ...
  CBO_CLEAN  -> List(Y, N, X, uopCFLSHWB,IQT_MEM, FU_MEM , RT_X  , RT_FIX  , RT_X  , N, IS_X, N, Y, N, N, N, M_FLUSH_ALL, 0.U, N, N, N, N, N, CSR.N),
  CBO_FLUSH  -> List(Y, N, X, uopCFLSH,IQT_MEM, FU_MEM , RT_X  , RT_FIX  , RT_X  , N, IS_X, N, Y, N, N, N, M_FLUSH_ALL, 0.U, N, N, N, N, N, CSR.N),
           //                                                                  frs3_en                           wakeup_delay
           //     is val inst?                                                 |  imm sel                        |   bypassable (aka, known/fixed latency)
           //     |  is fp inst?                                               |  |     uses_ldq                 |   |  is_br
           //     |  |  is single-prec?                        rs1 regtype     |  |     |  uses_stq              |   |  |
